...
class Locators:
    ...
    high_button_order = (By.XPATH, '//button[@class = "Button_Button__r12g"]')
    #кнопка заказа внизу страницы
    low_button_order = (By.XPATH, '//button[contains(@class = "Button_Middle__1CSJM")]')
    ...
    #кнопка "Далее"
    button_next = (By.XPATH, '//input[@placeholder = "Далее"]')
    ...
    #поле "Срок аренды"
    field_how_long = (By.XPATH, '//div[text()="* Срок аренды"]')
